	 ...
	 @Bean
	  SecurityFilterChain filterChain(HttpSecurity http) 
	    ...
	    http.authorizeHttpRequests()
	        ...
	        .requestMatchers(HttpMethod.POST, "/foto/create").hasAuthority("admin")		//per fare il POST su /pizza (richiesto per eliminare un libro) bisogna essere ADMIN//per accedere alle categorie bisogna essere ADMIN
